import { Accordion, AccordionDetails, AccordionSummary, Divider, Icon, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Typography } from '@mui/material'
import Logo from '../../../../assets/images/logo-mini.png'
import MenuIcon from '@mui/icons-material/Menu'
import { AccordionDetailsRoot, DrawerHeader, NavLinkIconMain, StyledAccordion, StyledAccordionSummary } from './DrawerContent.styles'
            ...
            <React.Fragment key={index}>
              <StyledAccordion expanded={expanded === item.module.moduelId} onChange={handleChangeAccordion(item.module.moduelId)}>
                <StyledAccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls={`${item.module.moduelId}-content`} id={`${item.module.moduleId}-header`}>
                  {item.module.moduleIcon.iconName ? (
                    <ListItemIcon className="itemIconMain">
                      <NavLinkIconMain>{item.module.moduleIcon.iconName}</NavLinkIconMain>
                    </ListItemIcon>
                  ) : (
                    <ListItemIcon className="itemIconMain">
                      <NavLinkIconMain>fiber_manual_record</NavLinkIconMain>
                    </ListItemIcon>
                  )}
                  {item.module.moduleName}
                </StyledAccordionSummary>
                <AccordionDetailsRoot>
                  <div>testtesttttesttttesttttesttttesttttesttttesttttesttttesttttesttttesttttesttttesttttt</div>
                  {/* <List component="nav" aria-label="navigation links" className={classes.listRoot}>
                    {item.pages.map((child) => (
                      <ListItem onClick={() => handleClick(child.pageUrl)} className={classes.listItem} button component={NavLink} to={child.pageUrl} key={child.pageId}>
                        {child.pageIcon.iconName ? (
                          <ListItemIcon className={classes.itemIcon}>
                            <Icon className={classes.navLinkIcon}>{child.pageIcon.iconName}</Icon>
                          </ListItemIcon>
                        ) : (
                          <ListItemIcon className={classes.itemIcon}>
                            <Icon className={classes.navLinkIcon}>fiber_manual_record</Icon>
                          </ListItemIcon>
                        )}
                        <ListItemText className={classes.listItemTextRoot}>{child.pageName}</ListItemText>
                      </ListItem>
                    ))}
                  </List> */}
                </AccordionDetailsRoot>
